...
class KnowledgeParsingHistory(Base, UUIDMixin, TimestampMixin):
    __tablename__ = "knowledge_parsing_histories"
    ...
    document: Mapped["KnowledgeBaseDocument"] = relationship(
        "KnowledgeBaseDocument", back_populates="parsing_histories"
    )
