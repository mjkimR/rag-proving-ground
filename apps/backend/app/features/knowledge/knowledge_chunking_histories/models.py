...
class KnowledgeChunkingHistory(Base, UUIDMixin, TimestampMixin):
    __tablename__ = "knowledge_chunking_histories"
    ...
    document: Mapped["KnowledgeBaseDocument"] = relationship(
        "KnowledgeBaseDocument", back_populates="chunking_histories"
    )
