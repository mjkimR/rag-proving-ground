import pytest
from rag_core.ai import models
...
def test_get_model_metadata_returns_correct_params(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    models._fetch_raw_model_info_from_gateway.cache_clear()
    models._get_model_metadata_map.cache_clear()
    monkeypatch.setattr(models, "_fetch_raw_model_info_from_gateway", lambda: mock_model_list)
